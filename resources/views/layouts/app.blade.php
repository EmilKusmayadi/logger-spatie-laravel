			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="../../demo1/dist/index.html" class="d-lg-none">
								<img alt="Logo" src="assets/media/logos/BosowaLogoB.png" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
											...
											<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
												...
												<div class="row">
													...
													<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
														...
														<div class="menu-item p-0 m-0">
															<!--begin:Menu link-->
															<a href="../../demo1/dist/dashboards/school.html" class="menu-link py-2 active">
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle" >
						<!--begin::Logo-->
						<div class="app-sidebar-logo px-4" id="kt_app_sidebar_logo" style="background-color: #0C4271;">
							<!--begin::Logo image-->
							<!--end::Logo image-->
						...
						<!--end::Logo-->
						<!--begin::sidebar menu-->
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid" style="background-color: #0C4271;">
							<!--begin::Menu wrapper-->
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
								...
								<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<!--end:Menu item-->
										<div class="menu-item pt-5 ms-15">
											<!--begin:Menu item-->
												<div class="menu-item">
													<!--begin:Menu link-->
													<li><a class="nav-link text-white" href="{{ route('users.index') }}">Users</a></li>
													<!--end:Menu link-->
												</div>
											<!--end:Menu item-->
											<!--begin:Menu item-->
											...
											<!--begin:Menu item-->
												<div class="menu-item mt-5">
													<!--begin:Menu link-->
													<li><a class="nav-link text-white" href="{{ route('permissions.index') }}">Permission</a></li>
													<!--end:Menu link-->
												</div>
											<!--end:Menu item-->
											<!--begin:Menu item-->
												<div class="menu-item mt-5">
													<!--begin:Menu link-->
													<li><a class="nav-link text-white" href="{{ route('products.index') }}">Product</a></li>
													<!--end:Menu link-->
												</div>
											<!--end:Menu item-->
											<!--begin:Menu item-->
